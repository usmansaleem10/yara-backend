...
# Procotes
procotes = [{ name: 'B', density: 1.415, west_canadian_price: 26.00, east_canadian_price: 24.00,
              us_price: 91.00, b_ratio: 0.1 },
            ...
            { name: 'Zn', density: 1.643, west_canadian_price: 36.00, east_canadian_price: 42.00, us_price: 138.00,
              zn_ratio: 0.7 },
            { name: 'BMZ', density: 1.580, west_canadian_price: 0.00, east_canadian_price: 38.00, us_price: 112.00,
              b_ratio: 0.06, mn_ratio: 0.1,
              zn_ratio: 0.2 },
            { name: 'BCMZ', density: 1.668, west_canadian_price: 38.00, east_canadian_price: 46.00, us_price: 160.00,
              b_ratio: 0.06, cu_ratio: 0.1, mn_ratio: 0.1, zn_ratio: 0.2 }]
...
crop_removals.each do |removal|
  ...
  crop = Crop.find_by(name: crop_name)
  crop.create_removal(ratios) unless crop.removal
end

puts '====================Crops Removal Ratio Added================'
puts '====================Adding regions================'
regions = { ECAN: { states: ['New Brunswick', 'Newfoundland', 'Labrador', 'Nova Scotia', 'Ontario',
                             'Prince Edward Island', 'Quebec'],
                    currency: 'east_canadian_price' },
            WCAN: { states: ['Alberta', 'British Columbia', 'Manitoba', 'Saskatchewan'],
                    currency: 'west_canadian_price' },
            US: { states: ['Alabama', 'Alaska', 'Arizona', 'Arkansas', 'California', 'Colorado',
